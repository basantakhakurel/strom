...
namespace strom
{
  ...
  // function to activate and deactivate the QMatrix object
  ...
  // function providing initial values for the four data members in this data class
  ...
  // function to provide a way to change the values
  ...
  // function to set up paramets according to the JC model
  ...
  // function that is not to be used but needed to be defined
  ...
  // function to get C-style arrays
  ...
  // function to obtain pointers to the C-style arrays
  ...
  // function that is not to be called but needed to be defined
  ...
  // function to set all 6 exchangeabilities to 1/6 and recalculate the rate matrix
  ...
  // function to copy the shared pointer to a vector of exchangeabilities
  ...
  // function to set the exchangeabilities to the values in the vector xchg and recalculate the rate matrix
  ...
  // function to set all the state frequencies to 0.25 and recalculate the rate matrix
  ...
  // function to copy the shared pointer to a vector of state frequencies
  ...
  // function to set the state frequencies to the values in the vector freqs and recalculate the rate matrix
  ...
  // function that needs not to be called
  inline void QMatrixNucleotide::setOmegaSharedPtr(QMatrix::omega_ptr_t omega)
  {
    assert(false);
  }
  ...
  // function to recalculate the rate matrix
  inline void QMatrixNucleotide::recalcRateMatrix()
  {
    ...
    double inverse_scaling_factor = piA * (rAC * piC + rAG * piG + rAT * piT) +
                                    piC * (rAC * piA + rCG * piG + rCT * piT) +
                                    piG * (rAG * piA + rCG * piC + rGT * piT) +
                                    piT * (rAT * piA + rCT * piC + rGT * piG);
