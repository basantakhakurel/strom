...
namespace strom
{
  ...
  public:
    ...
    std::vector<double> getCountsVector();
  ...
  // constructor, destructor and clear function
  ...
  // function to obtain the log of the prior probability of a tree topology with m internal nodes
  ...
  // function to recompute the topology prior vector
  void PolytomyTopoPriorCalculator::recalcPriorsImpl()
  {
    ...
    // Figure out the maximum possible value of m, the number of internal nodes
  ...
  // function for recalculation of polytomy_prior and counts (depending on different conditions)
  ...
  // function to return the count of the number of distinct labelled tree topologies for n taxa and m nodes
  ...
  // function to return number of fully-resolved trees for n taxa
  ...
  // function to construct a vector with log counts of the tree topologies with m internal nodes
  ...
  // function to return the natural log of the total number of trees for n taxa
  ...
  // function to construct a vector of realized resolution class priors from the values in the _topology_prior vector
  std::vector<double> PolytomyTopoPriorCalculator::getRealizedResClassPriorsVect()
  {
    ...
    // first loop will be to determine the largest value that will be factored out
  ...
  // function that samples a resolution class from the realized resolution class distribution
  ...
  // function to get and set number of taxa
  ...
  // function to set the _is_rooted data member to true
  ...
  // function to set the _is_rooted data member to false
  ...
  // function to choose between a resolution class prior or the polytomy prior
  ...
  // function to either set of return the value of the data member _C
  // which determines the nature of the resolution class or polytomy prior
  ...
  // function to set or return the _log_scaling_factor data member
  ...
  // function to return the _counts vector
  std::vector<double> PolytomyTopoPriorCalculator::getCountsVector()
  {
    if (_counts_dirty)
      reset();
    return _counts;
  ...
  // function to return the nfactors vector
  ...
  // function to return the topology_prior vector
  ...
  // function to return the result of call to getLogTopologyPrior(m)
  ...
  // function to return the natural log of the unnormalized topology prior
  ...
  // function to return the natural log of the normalizing constant for the topology prior
  ...
  // functions to check if it is a resolution class or polytomy prior
  ...
  // function to check if the tree is rooted
