...
namespace strom
{
  ...
  // function that returns the subset index corresponding to a given site
  ...
  // function to check if the specified site is in the specified subset
  ...
  // function calculating the number of sites assigned to the subset having the subset index
  ...
  // function called by constructor to return the Partition object to just constructed state
  ...
  // this is a private member function that breaks up a subset definition into a vector of component ranges
  ...
  // private member function that receives a subset index and a range definition, a range and an ending site
  ...
  // finalize function is called after the number of sites in known
  // it does three things --
  //          checks if number of sites sepcified is equal to the number of sites determined by the subset definitions
  //          checks whether any sites have slipped through the cracks and were not assigned any subset in the parition
  //          checks whether any sites are assigned to more than one subset
  ...
  // function for default partition (unpartitioned analyses)
