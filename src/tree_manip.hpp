...
namespace strom
{
  ...
  /**
   *  Stores the splits of the tree in a set.
   *
   *  This function first clears and resizes all splits in the tree.
   *  Then it performs a postorder traversal of the tree, adding the split
   *  of each internal node to the set and setting the bit corresponding
   *  to each leaf node's number in its split.
   *
   *  @param splitset The set in which to store the splits.
   *
   *  @return None
   *
   *  @throws None
