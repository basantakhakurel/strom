...
namespace strom
{
  ...
  inline ASRV::ASRV()
  {
    // std::cout << "Constructing a ASRV object" << std::endl;
    clear();
  }
  ...
  // function that returns a shared pointer to the rate variance across sites
  inline const ASRV::ratevar_ptr_t ASRV::getRateVarSharedPtr() const
  {
    return _ratevar;
  }

  // function that returns the variance of rates across sites
  ...
  // function that returns a shared pointer to the proportion of invariable sites
  inline const ASRV::pinvar_ptr_t ASRV::getPinvarSharedPtr() const
  {
    return _pinvar;
  }

  // function that returns the proportion of invariable sites
  ...
  // function to get pointer to the array of rates
  inline const double *ASRV::getRates() const
  {
    return &_rates[0];
  }

  // function to get pointer to the array of rate probabilities
  inline const double *ASRV::getProbs() const
  {
    return &_probs[0];
  }

  // function to return the value of _invar_model which determines whether this is an invariable sites model
  inline bool ASRV::getIsInvarModel() const
  {
    return _invar_model;
  }

  // function to return the number of rate categories
  inline unsigned ASRV::getNumCateg() const
  {
    return _num_categ;
  }

  // function to set the number of rate categories
  ...
  // function to assign a shared pointer to the rate variance across sites
  ...
  // function to set the value of the variance of rates across sites
  ...
  // function to assign a shared pointer to the proportion of invariable sites
  ...
  // function to set the value of the proportion of invariable sites
  ...
  // function to set the invariable sites model
  ...
  // function to fix the rate variance across sites and proportion of invariable sites
  ...
  // function to calculate the rates and probabilities
