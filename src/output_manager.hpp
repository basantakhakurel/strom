...
namespace strom
{
  ...
  // function to open and close the tree files to store trees sampled during MCMC
  ...
  // function to open and close the parameter file to store parameter values sampled during MCMC
  ...
  // function to output trees to the tree file
  ...
  // function to output parameter values to the parameter file
