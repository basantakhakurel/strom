...
namespace strom
{
  ...
  // function to call the parent's class version
  ...
  // function to return the current value of the gamma rate variance parameter
  inline double GammaRateVarUpdater::getCurrentPoint() const
  {
    return *(_asrv->getRateVarSharedPtr());
  }

  // function to calculate the prior probability of the gamma rate variance parameter (needed for compilation)
  ...
  // proposeNewState member function
