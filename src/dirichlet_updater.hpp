...
namespace strom
{
  ...
  // function to obtain the prior from the Updater class
  ...
  // updater works by centering a sharp (low variance) Dirichlet distribution over the current value of the parameter (_curr_point), then choosing the proposed value from that Dirichlet distribution.
