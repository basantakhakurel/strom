...
namespace strom
{
  ...
  // function to allow the user to set the seed
  ...
  // function to generate a draw from a uniform distribution and return the log of it
  ...
  // function to generate a random integer from a Normal distribution
  inline double Lot::normal()
  {
    return (*_normal_variate_generator)();
  }

  // function to generate a random integer from a Gamma distribution
  // if shape = _gamma_shape, Gamma(shape, 1) is used
  // if shape != _gamma_shape, Gamma(shape, scale) is used
  ...
  // function to generate a random integer from a uniform distribution
