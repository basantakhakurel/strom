...
namespace strom
{
  ...
  /**
   * Returns a shared pointer to a tree object at the specified index.
   *
   * @param index the index of the tree to retrieve
   *
   * @return a shared pointer to the tree object
   *
   * @throws XStrom if the index is out of range
   */
  ...
  /**
   * Returns the Newick string representation of a tree at the specified index.
   *
   * @param index the index of the tree to retrieve
   *
   * @return the Newick string representation of the tree
   *
   * @throws XStrom if the index is out of range
   */
  ...
  /**
   * Clears the stored tree IDs and Newick strings.
   *
   * @return None
   *
   * @throws None
  ...
  /**
   * Reads a tree file and stores the tree descriptions and corresponding split sets.
   *
   * @param filename the name of the file to read
   * @param skip the number of trees to skip at the beginning of each trees block
   *
   * @throws XStrom if an error occurs while reading the file
   */
  ...
  /**
   *  Displays a summary of the tree data read from a nexus file.
   *
   *  The summary includes the total number of trees read, a list of unique topologies
   *  with their corresponding tree indices, and a histogram of topologies sorted by
